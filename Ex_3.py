...
dont un example est donné ci-dessous, et un nombre. Cette fonction doit retourner la position de ce nombres, de la manière marquée ci-dessous. 
Si le nombre n'est pas dans le tableau, la fonction devra retourner None.
'''
...
# Classe, Subclasse, dictionnnaire, parcour par largeur, recursif, pile file listechaine, 